...
@section('content')
    <div class="row align-items-center justify-content-center text-center pt-5"
        style="margin-top: -25px; background-color:#214252; color:#fff">
        <div class="container">
        ...
        <div class="container">
            <div class="half-content d-lg-flex align-items-stretch">
                ...
                <div class="text">
                    ...
                    <p><a href="{{route('posts.show', 4)}}" class="btn btn-outline-primary py-2">Read more</a></p>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mb-4 text-center" data-aos="fade-up" data-aos-delay="100">
                    <img src="{{ asset('assets/images/لقطة شاشة 2024-07-18 135616.png') }}" alt="Image"
                        class="img-fluid w-50 rounded-circle mb-3">
                    <h5 class="text-black">Ashraf Mohamed</h5>
                    <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live
                        the blind texts. </p>
                </div>
                <div class="col-lg-4 mb-4 text-center" data-aos="fade-up" data-aos-delay="200">
                    <img src="{{ asset('assets/images/download (3).jpg') }}" alt="Image"
                        class="img-fluid w-50 rounded-circle mb-3">
                    <h5 class="text-black"> Wilson</h5>
                    <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live
                        the blind texts. </p>
                </div>
                ...
                <div class="col-lg-4 mb-4 text-center" data-aos="fade-up" data-aos-delay="100">
                    <img src="{{ asset('assets/images/download (2).jpg') }}" alt="Image"
                        class="img-fluid w-50 rounded-circle mb-3">
                ...
                <div class="col-lg-4 mb-4 text-center" data-aos="fade-up" data-aos-delay="200">
                    <img src="{{ asset('assets/images/images.jpg') }}" alt="Image"
                        class="img-fluid w-50 rounded-circle mb-3">
